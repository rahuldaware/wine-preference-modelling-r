...
ggplot(data= wineData, aes(x = wineData$alcohol, y = wineData$volatile.acidity, color = quality)) +
...
ggplot(data= wineData, aes(x = wineData$alcohol, y = wineData$pH, color = quality)) +
...
```{r echo=FALSE, cache=FALSE}
wineData$category <- factor(wineData$category, levels = c("bad","average","good","very.good"))
...
This plot shows that if both pH and Alcohol is high, the quality of red wine tends to be higher.  
