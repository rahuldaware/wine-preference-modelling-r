...
=======
  geom_histogram(binwidth = 1, fill = "blue", color = "black") 
>>>>>>> 680e5b4fb4f070fcf90263c83a5c7df5404796ab
...
Below is the hitogram os Red wine Free Sulfur Dioxide
...
ggplot(data= wineData, 
  ...
  geom_point() +
  scale_colour_gradient(low="blue", high="white", space="Lab")
```
...
```{r echo=FALSE, cache=FALSE}
ggplot(data= wineData, aes(x = wineData$alcohol, y = wineData$sulphates, color = category)) +
  scale_y_continuous("Sulphates (g / dm^3)") +
  scale_x_continuous("Alcohol % by volume") +
=======
```{r echo=FALSE, cache=FALSE}
ggplot(data= wineData, aes(x = wineData$alcohol, 
...
From the above plot, we can see that higher the volatile acidity, lower is the quality of wine.


```{r echo=FALSE, cache=FALSE}
ggplot(data= wineData, aes(x = wineData$alcohol, y = wineData$pH, color = category)) +
  scale_y_continuous("pH") +
  scale_x_continuous("Alcohol % by volume") +
  ggtitle("Relationship between quality, Alcohol and pH") +
  geom_point() +
...
pH does not show good impact on quality with alcohol in this plot. We cannot say with any confidence if pH affects the quality.   
